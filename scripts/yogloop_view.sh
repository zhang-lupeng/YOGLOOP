...
usage() {
    ...
    echo "  -m  Plot mode (class|gaussian|correct) [default: $MODE]"
...
case "$MODE" in
    ...
    *) echo "Error: Invalid mode '$MODE'. Must be one of: class, gaussian, correct" >&2; usage ;;
esac
...
if [ "$MODE" == "class" ]; then
    ...
    hicPlotMatrix -m ${CHROMOSOME}_${START_COORD}_class_matrix.h5 --colorMap Reds -o ${CHROMOSOME}_${START_COORD}_class_matrix.png
    ...
    hicPlotMatrix -m ${CHROMOSOME}_${START_COORD}_gaussian_matrix.h5 --colorMap Reds -o ${CHROMOSOME}_${START_COORD}_gaussian_matrix.png
    ...
    hicPlotMatrix -m ${CHROMOSOME}_${START_COORD}_correct_matrix.h5 --colorMap Reds -o ${CHROMOSOME}_${START_COORD}_correct_matrix.png
